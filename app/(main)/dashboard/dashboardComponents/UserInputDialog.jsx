            ...
            <DialogContent>
                ...
                <DialogDescription asChild>
                    <div className='mt-3'>
                        ...
                        <Textarea placeholder="Enter your topic here..." className='mt-3'
                        ...
                        <div className='grid grid-cols-3 md:grid-cols-5 gap-6 mt-3'>
                            {CoachingExpert.map((expert,index)=>(
                                ...
                                >
                                    ...
                                    width={100}
                                    height={100}
                                    className={`rounded-xl h-[80px] w-[80px] object-cover hover:scale-105 transition-all cursor-pointer p-1 
                                        border-primary
