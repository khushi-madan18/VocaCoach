...
function Credits() {
    ...
    const CalculateProgress = () => {
        if (userData?.subscriptionId) {
          ...
          return (Number(userData.credits) / 500000) * 100;
        } else {
          // FREE PLAN (50k tokens)
          return (Number(userData?.credits ?? 0) / 50000) * 100;
        }
      };
  ...
  return (
    <div>
        <div className='flex gap-5 items-center'>
            <Image src={user?.profileImageUrl} width={50} height = {50} alt="user profile"
        ...
        <div>
            ...
            <h2>{userData?.credits ?? 0}/{userData?.subscriptionId ? '500000' : '50000'}</h2>
